    ...
    <div class="bg-white shadow-md" x-data="{ isOpen: false }">
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex items-center justify-between">
                <a class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-purple-800 md:text-2xl hover:text-purple-400"
                   href="/">
                    Ally Gano Excel
                </a>
                <!-- Mobile menu button -->
            ...
            <div :class="isOpen ? 'flex' : 'hidden'"
                ...
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-purple-800 hover:text-purple-400"
                   href="/">Home</a>
                <a class="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-purple-800 hover:text-purple-400"
