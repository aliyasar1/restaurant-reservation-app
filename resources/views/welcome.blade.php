<x-guest-layout>ll
    ...
    <div
        ...
        style="background-image: url({{Storage::url('public/kizkulesi.jpg')}})">
        <h1
            class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-purple-800 md:text-center sm:leading-none lg:text-5xl">
            <span class="inline md:block">Welcome To Ally Gano Excel</span>
        </h1>
        <div class="mx-auto mt-2 text-purple-50 md:text-center lg:text-lg">
                ...
                <div class="w-full md:w-1/2 md:px-3">
                    <div class="w-full pb-6 space-y-4 sm:max-w-md lg:max-w-lg lg:space-y-4 lg:pr-0 md:pb-0">
                      ...
                      > -->
                        ...
                        <h2 class="text-4xl text-purple-600">Welcome</h2>
                        <!-- </h1> -->
    ...
    <section class="mt-8 bg-white">
        <div class="mt-4 text-center">
            ...
            <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-500">
            ...
            <div class="grid lg:grid-cols-4 gap-y-6">
                @foreach ($specials->menus as $menu)
                    <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                        <img class="w-full h-48" src="{{ \Illuminate\Support\Facades\Storage::url('public/menus/' . $menu->image) }}"
                             alt="Image" />
                        <div class="px-6 py-4">
                            <h4 class="mb-3 text-xl font-semibold tracking-tight text-purple-600 uppercase">{{ $menu->name }}</h4>
                            <p class="leading-normal text-gray-700">{{ $menu->description }}</p>
                        </div>
                        <div class="flex items-center justify-between p-4">
                            <span class="text-xl text-purple-600">₺ {{ $menu->price }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-purple-500 rounded-full"
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-purple-500">John Doe</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
